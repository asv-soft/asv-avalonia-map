    ...
    public class MapyCZProjection : PureProjection
    {
        ...
        double[] WGSToUTM(double la, double lo, int zone)
        {
            ...
            double g =
                ...
                * (1.0 - n)
                * (1.0 - n * n)
                * (1.0 + 9 / 4.0 * n * n + 255.0 / 64.0 * Pow(n, 4))
                * (PI / 180.0);
            ...
            double m =
                a
                * (
                    a0 * latrad - a2 * Sin(2 * latrad) + a4 * Sin(4 * latrad) - a6 * Sin(6 * latrad)
                );
            ...
            double eterm3 =
                ...
                / 5040.0
                * Pow(coslat, 6)
                * (61.0 - 479 * t * t + 179 * Pow(t, 4) - Pow(t, 6));
            ...
            double nterm2 =
                Pow(w, 4) / 24.0 * nu * sinlat * Pow(coslat, 3) * (4 * psi * psi + psi - t * t);
            double nterm3 =
                Pow(w, 6)
                / 720.0
                * nu
                ...
                * Pow(coslat, 5)
                * (
                    8 * Pow(psi, 4) * (11.0 - 24 * t * t)
                    - 28 * Pow(psi, 3) * (1.0 - 6 * t * t)
                    + psi * psi * (1.0 - 32 * t * t)
                    - psi * 2 * t * t
                    + Pow(t, 4)
                );
        ...
        double[] UTMToWGS(double eastIn, double northIn, int zone)
        {
            ...
            double g =
                ...
                * (1.0 - n)
                * (1.0 - n * n)
                * (1.0 + 9 / 4.0 * n * n + 255 / 64.0 * Pow(n, 4))
                * (PI / 180.0);
            ...
            double footlat =
                sigma
                + (3 * n / 2.0 - 27 * Pow(n, 3) / 32.0) * Sin(2 * sigma)
                + (21 * n * n / 16.0 - 55 * Pow(n, 4) / 32.0) * Sin(4 * sigma)
                + 151 * Pow(n, 3) / 96.0 * Sin(6 * sigma)
                + 1097 * Pow(n, 4) / 512.0 * Sin(8 * sigma);
            ...
            double laterm3 =
                ...
                * (east * Pow(x, 5) / 720.0)
                * (
                    8 * Pow(psi, 4) * (11 - 24 * t * t)
                    - 12 * Pow(psi, 3) * (21.0 - 71 * t * t)
                    + 15 * psi * psi * (15.0 - 98 * t * t + 15 * Pow(t, 4))
                    + 180 * psi * (5 * t * t - 3 * Pow(t, 4))
                    + 360 * Pow(t, 4)
                );
            double laterm4 =
                t
                / (k * rho)
                * (east * Pow(x, 7) / 40320.0)
            ...
            double loterm4 =
                ...
                / 5040.0
                * seclat
                * (61.0 + 662 * t * t + 1320 * Pow(t, 4) + 720 * Pow(t, 6));
        ...
        public override GeoPoint FromPixelToLatLng(long x, long y, int zoom)
        {
            ...
            var l = PPToWGS(oX, oY);
            return new GeoPoint(
                Clip(l[0], MinLatitude, MaxLatitude),
                Clip(l[1], MinLongitude, MaxLongitude),
                0
            );
        }
