...
!define PRODUCT_NAME "Asv.Avalonia.Map"
...
Name "Asv Avalonia Map Demo"
OutFile "AvaloniaAppInstaller.exe"
InstallDir "$PROGRAMFILES\Avalonia\DemoMap"
...
Function un.onInit
  MessageBox MB_ICONQUESTION|MB_YESNO|MB_DEFBUTTON2 "Are you sure you want to completely remove Avalonia Map Demo and all of its components?" IDYES +2
  Abort
FunctionEnd
